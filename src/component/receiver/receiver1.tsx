...
class Receiver1 extends React.Component<cardGottenProps, any> {
    ...
    render() {
        if (this.state.isFlipped && this.state.card!=null) {
            ...
            return <Receiver2 card={this.state.card} setCard={this.setCard}/>
        }
        return(
            ...
            <div className="GC2texts">
                ...
                <div className="GC2yelloBox">
                    ...
                    <div className="GC2insideYellow" //onClick={() => setFlip(!flip)}>
                     onClick={(e) => this.cardBack(e)}>
